  ...
  const validateAndGetPayload = () => {
    ...
    if (newQty > stock) {
      showToast(
        `You already have ${
          itemInCart?.qty || 0
        } in cart. Only ${stock} items in stock.`,
        "error"
      );
      return null;
    }
          ...
          <div className="space-y-6">
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded border text-sm ${
                        size === s
                          ...
                          : "border-gray-300 dark:border-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-800/50 dark:text-gray-300"
                      }`}
                    >
                      {s}
                    </button>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center border rounded-md dark:border-zinc-700">
                ...
                <button
                  onClick={() =>
                    setQty((q) => Math.min(Number(product.countInStock), q + 1))
                  }
            ...
            <div className="pt-4 space-y-2">
              ...
              <Accordion title="Materials & Care">
                ...
                <p className="mt-2">
                  Care: Dry clean only. Store in a muslin cloth.
                </p>
              </Accordion>
              <Accordion title="Shipping & Returns">
                <p>
                  • Free shipping across India. Dispatched in 2-3 business days.
                </p>
                <p className="mt-2">
                  • 30-day free returns. Item must be in original, unused
      ...
      <section className="mt-12 pt-8 border-t border-gray-200 dark:border-zinc-700">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {reviewsLoading ? (
              ...
              <div className="mt-6 space-y-6">
                {reviews.map((r) => (
                  <div
                    key={r._id}
                    className="border-b pb-4 dark:border-zinc-700"
                  >
                    <div className="flex items-center gap-2">
                      <strong className="dark:text-white">{r.userName}</strong>
          ...
          <button
            ...
            className="border rounded-lg px-4 py-2 hover:bg-gray-50 dark:border-zinc-700 dark:text-gray-300 dark:hover:bg-zinc-800 w-full sm:w-auto"
          >
            Write a Review
          </button>
        </div>
